                ...
                <form id="applyForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group  col-md-6">
                            ...
                            <input type="text" class="form-control" id="sia_licence_number"
                                name="sia_licence_number" value="">
                        </div>
                        <div class="form-group  col-md-6">
                            <label for="sia_licence_expiry_date">Expiry Date</label>
                            <input type="date" class="form-control" id="sia_licence_expiry_date"
                                name="sia_licence_expiry_date" min="{{ now()->toDateString() }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="driving_licence_type"
                                name="driving_licence_type" value="">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="criminal_offence_present"
                                name="criminal_offence_present">
                                <option value="1">Yes</option>
                                <option value="0">No</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="criminal_offence_details"
                                name="criminal_offence_details" value="">
                        </div>
                    </div>
