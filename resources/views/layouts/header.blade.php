                ...
                <nav class="navbar navbar-expand-lg custom_nav-container">
                    ...
                    <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
                        <ul class="navbar-nav  ">
                            ...
                            <li
                                class="nav-item {{ Route::is('services', 'reception-security-detail', 'site-security-detail', 'door-security-detail', 'events-security-detail', 'personal-body-guard-security-detail', 'shopping-malls-security-detail') ? 'active' : '' }}">
