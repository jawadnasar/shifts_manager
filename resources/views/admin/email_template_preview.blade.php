            ...
            <div class="">
                <form id="send_email_form" action="{{ route('send_email') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <textarea name="email_body" id="email_body" class="form-control" rows="10">{{ $template->body }} 
                                {{-- {{ Auth::user()->name }} --}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <textarea input type="text" name="email_footer" id="email_footer" rows='5' class="form-control">{{ $template->footer }}</textarea>
                        </div>
                    </div>
