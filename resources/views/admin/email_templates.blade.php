...
@section('content')
    {{-- Making the content of the table collapsible START --}}
    <style>
        /* Fixed width and height for email body and footer */
        .fixed-size {
            width: 200px;
            /* Fixed width */
            height: 100px;
        ...
        <div class="container-fluid">
            <div class="text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addTemplateModal">Add New
                        Template</button>
                </div>
                            ...
                            <tbody>
                                @foreach ($templates as $key => $template)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fixed-size collapsible" onclick="toggleCollapse(this)">
                                                {{ $template->body }}
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger delete-template-btn" data-id="{{ $template->id }}"
                                            ...
                                            <button class="btn btn-primary edit-template-btn" data-id="{{ $template->id }}"
                                                ...
                                                data-body="{{ $template->body }}" data-footer="{{ $template->footer }}"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.status === 'success') {
                                ...
                                window.location
                            .reload(); // Refresh the page to reflect the change
                            } else {
                                toastr.error('Oops, Error: ' + data.msg);
                            }
                        },
